...
if (isset($_POST['submit'])) {
    ...
    $loginsql = "SELECT * FROM usersadm WHERE username='$username' AND password='$password'";
...
<body class="bg-dark">
    ...
    <div class="card p-3 box position-absolute top-50 start-50 translate-middle">
        ...
        <span class="text-center">Kembali ke <a class="fw-bold none " href="../index.php">login Siswa </a> </span>
    </div>
</body>
